...
<div class = "col-lg-3"></div>
   ...
   //     String q1="insert into llogin values('"+username+"' ,'"+password+"');";
        String q2="insert into vijay values('"+Name+"' ,'"+Phone+"','"+Date+"','"+gender+"','"+email+"','"+Time+"','"+Datebirth+"','"+Address+"');";
  //      SqlUtil.insert(q1);
        SqlUtil.insert(q2);
        %>
        <script>alert("Data Submitted Successfully");document.location.href='Indian_seat.jsp';</script>        
        <%
            }catch(Exception ex)
            {
