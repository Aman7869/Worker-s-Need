...
<%-- 
    Document   : signup
    Created on : Aug 13, 2018, 6:12:52 PM
    Author     : shubham
--%>
...
<html>
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" style="color: white" href="#">Suman, Maid</a>
    </div>
...
<div class = "col-lg-3"></div>
   ...
   //     String q1="insert into llogin values('"+username+"' ,'"+password+"');";
        String q2="insert into suman values('"+Name+"' ,'"+Phone+"','"+Date+"','"+gender+"','"+email+"','"+Time+"','"+Datebirth+"','"+Address+"');";
  //      SqlUtil.insert(q1);
        SqlUtil.insert(q2);
        %>
        <script>alert("Data Submitted Successfully");document.location.href='Suman.jsp';</script>        
        <%
            }catch(Exception ex)
            {
